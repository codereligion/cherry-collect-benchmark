...
public class ListFilteringAndTransformationBenchmarkInputFactory implements InputFactory {
    ...
    private static class ArrayListsInput implements Input {
        ...
        public Set<String> getTags() {
            return Sets.newHashSet("filter", "transform", "ArrayLists", "elements: " + Iterables.size(iterable));
        }
    ...
    private class FluentIterableInput implements Input {
        ...
        @Override
        public Set<String> getTags() {
            return Sets.newHashSet("filter", "transform", "FluentIterable", "elements: " + Iterables.size(iterable));
        }
